    ...
    <div className="space-y-4">
      ...
      <div className="card p-4 space-y-3 bg-blue-950/20 border border-blue-500/20">
        ...
        <p className="text-xs text-muted">
          Real inventory data across distribution centers. Shows at-risk, reorder, and healthy stock scenarios.
        </p>
        <div className="relative">
          <textarea
            readOnly
            value={`Distribution Center	Product/UPC	Description	On Hand Quantity	Avg Weekly Sales	On Purchase Order Quantity
BLO	85002576584	BEV SPRKL TROPICAL	10716	312	0
NCA	85002576526	BEV SPRKL ENRG PSSN ORNGE	7668	43	0
ROM	85002576524	BEV SPRK ENRG BLKBRY LMN	6576	358	0
DFW	85002576528	BEV SPRKL ENRG DRGFRT LMN	6444	283	0
BLO	85002576528	BEV SPRKL ENRG DRGFRT LMN	5760	568	0
ROM	85002576528	BEV SPRKL ENRG DRGFRT LMN	4716	416	0
BLO	85002576562	BEV SPRKL PNPLE MANGO	4476	578	0
DFW	85002576524	BEV SPRK ENRG BLKBRY LMN	3912	240	0
ROM	85002576526	BEV SPRKL ENRG PSSN ORNGE	3876	210	0
CHN	85002576562	BEV SPRKL PNPLE MANGO	3852	556	2496
BLO	85002576524	BEV SPRK ENRG BLKBRY LMN	3564	423	312
DFW	85002576526	BEV SPRKL ENRG PSSN ORNGE	3144	212	0
DFW	85002576562	BEV SPRKL PNPLE MANGO	2688	405	0
ROM	85002576539	ENRGY DNK SPRK ORAN GING	2616	172	0
NCA	85002576528	BEV SPRKL ENRG DRGFRT LMN	2544	59	0
CHN	85002576528	BEV SPRKL ENRG DRGFRT LMN	2280	194	0
BLO	85002576587	BEV SPRKL PINK LEMONADE	2268	207	624
ROM	85002576562	BEV SPRKL PNPLE MANGO	2124	234	0
DFW	85002576563	BEV SPRKL BLUE RASPBERRY	1920	300	0
BLO	85002576587	BEV SPRKL PINK LEMONADE	1644	129	0
DGV	85002576528	BEV SPRKL ENRG DRGFRT LMN	816	41	0
DGV	85002576539	ENRGY DNK SPRK ORAN GING	312	10	0
DGV	85002576524	BEV SPRK ENRG BLKBRY LMN	276	1	0
DGV	85002576526	BEV SPRKL ENRG PSSN ORNGE	12	39	1584
NCA	85002576584	BEV SPRKL TROPICAL	0	6	72
NCA	85002576583	BEV SPRKL COLA	0	3	0`}
            className="w-full h-56 p-3 text-xs font-mono bg-black/40 border border-white/10 rounded resize-none"
          />
          <button
            onClick={() => {
              const text = `Distribution Center	Product/UPC	Description	On Hand Quantity	Avg Weekly Sales	On Purchase Order Quantity
BLO	85002576584	BEV SPRKL TROPICAL	10716	312	0
NCA	85002576526	BEV SPRKL ENRG PSSN ORNGE	7668	43	0
ROM	85002576524	BEV SPRK ENRG BLKBRY LMN	6576	358	0
DFW	85002576528	BEV SPRKL ENRG DRGFRT LMN	6444	283	0
